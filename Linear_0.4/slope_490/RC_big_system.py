...
#path = glob.glob("../../../dp_LDL/Dataset/P1725_T188/data1/new_coord/*npy")
#path = glob.glob("../../../dp_LDL/Dataset/P1725_T188/data2/new_coord/*npy")
#path = glob.glob("../../../dp_LDL/Dataset/P1725_T188/data3/new_coord/*npy")
#path = glob.glob("../../../dp_LDL/Dataset/P1500_T198/data1/new_coord/*npy")
#path = glob.glob("../../../dp_LDL/Dataset/P1500_T198/data2/new_coord/*npy")
#path = glob.glob("../../../dp_LDL/Dataset/P1500_T195/data1/new_coord/*npy")
#path = glob.glob("../../../dp_LDL/Dataset/P1500_T195/data2/new_coord/*npy")
#path = glob.glob("../../../dp_LDL/BalanceDataset/P1250_T215/data1/new_coord/*npy")
#path = glob.glob("../../../dp_LDL/BalanceDataset/P1250_T215/data2/new_coord/*npy")
#path = glob.glob("../../../dp_LDL/BalanceDataset/P1250_T220/data1/new_coord/*npy")
PT = "P1250_T220/data2"
PT = sys.argv[1]
#if len(sys.argv)==3:
#    TI = sys.argv[2]
...
#    TI = 0
TI = sys.argv[2]
path = glob.glob("../../../dp_LDL/big_system/"+PT+"/new_coord/*npy")
...
class LDL_Data_Feeder:
    ...
    def Generator_test_Dataset(self):
        ...
        #suf_path = '../../../dp_LDL/Dataset/P1725_T188/data1/new_coord'#####################
        #suf_path = '../../../dp_LDL/Dataset/P1725_T188/data2/new_coord'#####################
        #suf_path = '../../../dp_LDL/Dataset/P1725_T188/data3/new_coord'#####################
        #suf_path = '../../../dp_LDL/Dataset/P1500_T198/data1/new_coord'
        #suf_path = '../../../dp_LDL/Dataset/P1500_T198/data2/new_coord'
        #suf_path = '../../../dp_LDL/Dataset/P1500_T195/data1/new_coord'
        #suf_path = '../../../dp_LDL/Dataset/P1500_T195/data2/new_coord'
        #suf_path = '../../../dp_LDL/BalanceDataset/P1250_T215/data1/new_coord'
        #suf_path = '../../../dp_LDL/BalanceDataset/P1250_T215/data2/new_coord'
        #suf_path = '../../../dp_LDL/BalanceDataset/P1250_T220/data1/new_coord'
        suf_path = '../../../dp_LDL/big_system/'+self.PT+'/new_coord'
        panding_0= float((self.PT).split('/data')[-1])
        #suf_path = '../../../dp_LDL/BalanceDataset/P100_T235/data1/new_coord'#####################
        for i in range(path.shape[0]):
            if panding_0 == 1:
                if self.TI == 0:
                    #filename = str((i*4000)+200)                     ####### data1
                    filename = str((i*100000)+0)
                if self.TI == 3:
                    filename = str((i*20000)+200)
            if panding_0 == 2:
                filename = str((i*4000)+2200)                          ####### data2
            #if panding_0 == 3:
            #    filename = str((i+20000)+200)
            #filename = str((i*20000)+500000)                      ####### data3
            ###
...
model_decoder=decoder_ANN_rho(250,1,30000,0.1)
...
def loss_function_1(pred_rho,real_rho,pred_pot,real_pot,normal_y3,x4,x3):
    ...
    x3 = tf.reshape(x3,(-1,30000,1))
    x4 = tf.reshape(x4,(-1,30000,1))
    bsz= x4.shape[0]
...
def test_step(coord,rho,pot,temp,press,epoch,oldc,boxx,boxy,boxz):
    selfpt = ((PT).split('/data')[0])
    filename = "./big_system/test"+selfpt+".log"
    fle = open(filename,'a')
    Prho,x3,x2,x1, Ppot,y3,y2,y1 = model_encoder(coord, temp, press, training=True)
    x3,y3,x4, normal_x3,normal_y3 = model_decoder(x3,x2,x1, y3,y2,y1, temp,press,training=True)
    loss1, loss2, loss_rho, loss_pot, aa_loss,linear_aax4,loss_correlation = loss_function_1(Prho,rho, Ppot,pot, normal_y3,x4,x3)
    ...
    filename1 = "./big_system/xe"+selfpt+".log"
    ...
    oldc = tf.reshape(oldc,(30000,4))
    sequence = tf.range(1,30001, dtype=tf.float32)
    sequence = tf.reshape(sequence, (30000,1))
    ...
    tf.print(lint,summarize=30000,output_stream = 'file://'+flx.name)
...
for epoch in range(1):
    ...
    test_Feeder = LDL_Data_Feeder(
        path, PT, TI, max_batch_system = 1, local_atom_maxN = 31, system_OatomN = 30000
    )
