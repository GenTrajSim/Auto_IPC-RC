...
#x = x[sample_indices]
#y = y[sample_indices]
x_edges=np.linspace(-874.927,1034.927,100)
...
plt.imshow(H_prob.T,vmin = 0 ,vmax=0.003, origin='lower', extent=[-874.927,1034.927,-2,2],aspect='auto',cmap='jet')
...
plt.gca().xaxis.set_major_locator(MultipleLocator(400))
