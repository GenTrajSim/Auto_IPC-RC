...
#path = glob.glob("../../../dp_LDL/Dataset/P1600_T193/data1/new_coord/*npy")
path = glob.glob("../../../dp_LDL/Dataset/P1600_T193/data2/new_coord/*npy")
...
class LDL_Data_Feeder:
    ...
    def Generator_test_Dataset(self):
        ...
        #suf_path = '../../../dp_LDL/Dataset/P1600_T193/data1/new_coord'#####################
        suf_path = '../../../dp_LDL/Dataset/P1600_T193/data2/new_coord'#####################
